# Cyclistic Bike Share - Google Data Analytics Capstone Project (Eng. Version PDF is coming soon!)
...
สามารถนำไปดูและต่อยอดได้เลย จริงมันสามารถวิเคราะห์ลึกกว่านี้ได้อีก เช่น การหา trip ที่ผิดปกติ หรือ วิเคราะห์ตำแหน่งอย่างละเอียดขึ้น เราจะสามารถเห็นจุดที่สำคัญได้ดีขึ้น สามารถตั้งสถานีใหม่ หรือ allocated ทรัพยากรไปลงจุดนั้นได้ดีขึ้น
